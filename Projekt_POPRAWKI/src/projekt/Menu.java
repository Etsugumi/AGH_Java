...
public class Menu extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        this.dispose();
        LoggedIn log = new LoggedIn("test");
        log.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        signup.setResizable(false); //blokada zmiany rozmiaru ekranu
        signup.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //standardowe wyjście z programu
        signup.setLocationRelativeTo(null); //umieszczenie okna na ekranie
